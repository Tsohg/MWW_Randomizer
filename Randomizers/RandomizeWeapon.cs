...
namespace MWW_Randomizer.Randomizers
{
    class RandomizeWeapon : BaseRandomize
    {
        string[] weapons = ("weapon_arakh_sword,weapon_arcane_axe,weapon_arcane_sword,weapon_barnacle_blade,weapon_baseball_bat,weapon_bear_claw,weapon_bearded_axe," +
            ...
            "weapon_headmaster_blade,weapon_heavy_metal_axe,weapon_ice_blade,weapon_ice_brand,weapon_keytar,weapon_laser_sword,weapon_laser_sword_crafted_blackblue," +
            ...
            "weapon_laser_sword_crafted_red,weapon_laser_sword_crafted_yellow,weapon_laser_sword_rainbow,weapon_lightning_spear,weapon_longinus,weapon_mjolnir,weapon_moon," +
